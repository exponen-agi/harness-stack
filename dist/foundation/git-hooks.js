 ...
 */
export function installGitHook(repoRoot, hookName, hookBody) {
    ...
    const updated = existing.slice(0, beginIdx) + block + existing.slice(endIdx + END_MARKER.length);
